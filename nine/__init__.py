...
if IS_PYTHON2:
    ...
    implements_to_string = (
        implements_iterator
    ) = implements_repr = nine = lambda cls: cls
...
_moved = {  # Mapping from Python 3 to Python 2 location. May need improvement.
    ...
    "urllib.request:HTTPPasswordMgrWithDefaultRealm": "urllib2:HTTPPasswordMgrWithDefaultRealm",
    "urllib.request:AbstractBasicAuthHandler": "urllib2:AbstractBasicAuthHandler",
    ...
    "urllib.request:AbstractDigestAuthHandler": "urllib2:AbstractDigestAuthHandler",
